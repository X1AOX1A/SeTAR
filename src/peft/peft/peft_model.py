...
PEFT_TYPE_TO_MODEL_MAPPING = {
    ...
    PeftType.MODIFIED_LORA: ModifiedLoraModel,
    ...
    **Attributes**:
    ...
    def __init__(self, model: PreTrainedModel, peft_config: PeftConfig, adapter_name: str = "default",
        ...
        if self._is_prompt_learning:
            ...
            try:
                # verbose only available to ModifiedLoraModel
                self.base_model = cls(model, {adapter_name: peft_config}, adapter_name, verbose=verbose)
            except TypeError:
                self.base_model = cls(model, adapter_name=adapter_name, verbose=verbose)
