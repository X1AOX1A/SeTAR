...
def get_ood_datasets(id_dataset):
    """Get the list of OOD datasets for the given ID dataset."""
    if id_dataset == "ID_ImageNet1K":
        ood_datasets = ["OOD_iNaturalist", "OOD_Sun", "OOD_Places", "OOD_Texture"]
    elif id_dataset == "ID_COCO":
        ood_datasets = ["OOD_iNaturalist", "OOD_Sun", "OOD_Places", "OOD_Texture",
                        "OOD_ImageNet22K", "OOD_VOC"]
    elif id_dataset == "ID_VOC":
        ood_datasets = ["OOD_iNaturalist", "OOD_Sun", "OOD_Places", "OOD_Texture",
                        "OOD_ImageNet22K", "OOD_COCO"]
    else:
        raise ValueError(f"Invalid ID dataset: {id_dataset}")
    return ood_datasets


def get_id_labels(id_dataset):
    """Get the class labels of the given ID dataset for classification."""

    def obtain_ImageNet1K_classes():
        class_name = [
            ...
            'centipede', 'black grouse', 'ptarmigan', 'ruffed grouse', 'prairie grouse', 'peafowl',
            ...
            'duck', 'red-breasted merganser', 'goose', 'black swan', 'tusker', 'echidna', 'platypus',
            'wallaby', 'koala', 'wombat', 'jellyfish', 'sea anemone', 'brain coral', 'flatworm',
            'nematode', 'conch', 'snail', 'slug', 'sea slug', 'chiton', 'chambered nautilus',
            ...
            'lion', 'tiger', 'cheetah', 'brown bear', 'American black bear', 'polar bear',
            'sloth bear', 'mongoose', 'meerkat', 'tiger beetle', 'ladybug', 'ground beetle',
            'longhorn beetle', 'leaf beetle', 'dung beetle', 'rhinoceros beetle', 'weevil', 'fly',
            'bee', 'ant', 'grasshopper', 'cricket insect', 'stick insect', 'cockroach',
            ...
            'sea urchin', 'sea cucumber', 'cottontail rabbit', 'hare', 'Angora rabbit', 'hamster',
            'porcupine', 'fox squirrel', 'marmot', 'beaver', 'guinea pig', 'common sorrel horse',
            ...
            'Asian elephant', 'African bush elephant', 'red panda', 'giant panda', 'snoek fish',
            'eel', 'silver salmon', 'rock beauty fish', 'clownfish', 'sturgeon', 'gar fish',
            'lionfish', 'pufferfish', 'abacus', 'abaya', 'academic gown', 'accordion',
            ...
            'barrel', 'wheelbarrow', 'baseball', 'basketball', 'bassinet', 'bassoon', 'swimming cap',
            ...
            'bottle cap', 'hunting bow', 'bow tie', 'brass memorial plaque', 'bra', 'breakwater',
            ...
            'cardigan', 'car mirror', 'carousel', 'tool kit', 'cardboard box / carton', 'car wheel',
            ...
            'grocery store', 'guillotine', 'hair clip', 'hair spray', 'half-track', 'hammer',
            ...
            'lotion', 'music speaker', 'loupe magnifying glass', 'sawmill', 'magnetic compass',
            ...
            'parallel bars', 'park bench', 'parking meter', 'railroad car', 'patio', 'payphone',
            ...
            'plant pot', "potter's wheel", 'power drill', 'prayer rug', 'printer', 'prison',
            'missile', 'projector', 'hockey puck', 'punching bag', 'purse', 'quill', 'quilt',
            'race car', 'racket', 'radiator', 'radio', 'radio telescope', 'rain barrel',
            'recreational vehicle', 'fishing casting reel', 'reflex camera', 'refrigerator',
            'remote control', 'restaurant', 'revolver', 'rifle', 'rocking chair', 'rotisserie',
            'eraser', 'rugby ball', 'ruler measuring stick', 'sneaker', 'safe', 'safety pin',
            ...
            'space shuttle', 'spatula', 'motorboat', 'spider web', 'spindle', 'sports car',
            'spotlight', 'stage', 'steam locomotive', 'through arch bridge', 'steel drum',
            'stethoscope', 'scarf', 'stone wall', 'stopwatch', 'stove', 'strainer', 'tram',
            ...
            'pomegranate', 'hay', 'carbonara', 'chocolate syrup', 'dough', 'meatloaf', 'pizza',
            'pot pie', 'burrito', 'red wine', 'espresso', 'tea cup', 'eggnog', 'mountain', 'bubble',
            'cliff', 'coral reef', 'geyser', 'lakeshore', 'promontory', 'sandbar', 'beach', 'valley',
    ...
    def obtain_COCO_classes():
        class_name = [
            'traffic light', 'fire hydrant', 'stop sign', 'parking meter', 'bench', 'bird', 'cat',
            'dog', 'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra', 'giraffe', 'frisbee',
            'skis', 'snowboard', 'sports ball', 'kite', 'baseball bat', 'baseball glove',
            'skateboard', 'surfboard', 'tennis racket', 'bottle', 'wine glass', 'cup', 'fork',
            'knife', 'spoon', 'bowl', 'banana', 'apple', 'sandwich', 'orange', 'broccoli', 'carrot',
            'hot dog', 'pizza', 'donut', 'cake', 'chair', 'couch', 'bed', 'dining table', 'toilet',
            'tv', 'laptop', 'mouse', 'remote', 'keyboard', 'cell phone', 'book', 'clock', 'vase',
            'scissors', 'teddy bear', 'hair drier', 'toothbrush'
        ]
        return class_name

    def obtain_VOC_classes():
        class_name = [
            'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'cow', 'diningtable', 'dog', 'horse',
            'motorbike', 'sheep', 'sofa', 'train', 'tvmonitor'
        ]
        return class_name

    if id_dataset == "ID_ImageNet1K":
        id_labels = obtain_ImageNet1K_classes()
    elif id_dataset == "ID_COCO":
        id_labels = obtain_COCO_classes()
    elif id_dataset == "ID_VOC":
        id_labels = obtain_VOC_classes()
    else:
        raise ValueError(f"Invalid ID dataset: {id_dataset}")
    return id_labels